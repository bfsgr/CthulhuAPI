...
ActiveRecord::Schema.define(version: 2021_03_05_182324) do
  ...
  create_table "occupations", force: :cascade do |t|
    ...
    t.index ["name", "game_set_id"], name: "index_occupations_on_name_and_game_set_id", unique: true
  end
  ...
  create_table "picks", force: :cascade do |t|
    ...
    t.index ["name", "game_set_id"], name: "index_picks_on_name_and_game_set_id", unique: true
  end
  ...
  create_table "skills", force: :cascade do |t|
    ...
    t.index ["name", "game_set_id"], name: "index_skills_on_name_and_game_set_id", unique: true
  end
