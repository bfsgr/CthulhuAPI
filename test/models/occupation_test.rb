...
class OccupationTest < ActiveSupport::TestCase
  test "occupation saves correctly" do
    oc = Occupation.new(name: "Advogado", min_credit: 30, max_credit: 70, calcType: "EDUx4",  game_set: game_sets(:default))
  ...
  test "two occupations should not save with the same name in the same game set" do
    oc1 = Occupation.new(name: "Advogado", min_credit: 30, max_credit: 70, calcType: "EDUx4", game_set: game_sets(:default))  
    
    assert oc1.save
    
    oc2 = Occupation.new(name: "Advogado", min_credit: 30, max_credit: 70, calcType: "EDUx4", game_set: game_sets(:default))  
  ...
  test "two occupations should save with the same name in different game sets" do
    ...
    oc2 = Occupation.new(name: "Advogado", min_credit: 30, max_credit: 70, calcType: "EDUx4", game_set: game_sets(:modern))  
